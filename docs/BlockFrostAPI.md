...
- [epochsLatestParameters](../wiki/BlockFrostAPI#epochslatestparameters)
...
• **accountsWithdrawals**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `stakeAddress`: `string`, `pagination?`: `PaginationOptions`) => `Promise`<`components`[``"schemas"``][``"account_withdrawal_content"``]\> = `accountsWithdrawals`
...
• **addressesUtxos**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `address`: `string`, `pagination?`: `PaginationOptions`) => `Promise`<`components`[``"schemas"``][``"address_utxo_content"``]\> = `addressesUtxos`
...
• **poolsAll**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `allMethodOptions?`: `AllMethodOptions`) => `Promise`<`components`[``"schemas"``][``"pool_list"``]\> = `poolsAll`
...
• **poolsById**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `poolId`: `string`) => `Promise`<`components`[``"schemas"``][``"pool"``]\> = `poolsById`
...
• **poolsByIdBlocks**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `poolId`: `string`, `pagination?`: `PaginationOptions`) => `Promise`<`components`[``"schemas"``][``"pool_blocks"``]\> = `poolsByIdBlocks`
...
• **poolsByIdDelegators**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `poolId`: `string`, `pagination?`: `PaginationOptions`) => `Promise`<`components`[``"schemas"``][``"pool_delegators"``]\> = `poolsByIdDelegators`
...
• **poolsByIdHistory**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `poolId`: `string`, `pagination?`: `PaginationOptions`) => `Promise`<`components`[``"schemas"``][``"pool_history"``]\> = `poolsByIdHistory`
...
• **poolsByIdRelays**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `poolId`: `string`) => `Promise`<`components`[``"schemas"``][``"pool_relays"``]\> = `poolsByIdRelays`
...
• **poolsByIdUpdates**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `poolId`: `string`, `pagination?`: `PaginationOptions`) => `Promise`<`components`[``"schemas"``][``"pool_updates"``]\> = `poolsByIdUpdates`
...
• **poolsExtended**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `pagination?`: `PaginationOptions`) => `Promise`<`components`[``"schemas"``][``"pool_list_extended"``]\> = `poolsExtended`
...
• **poolsExtendedAll**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `allMethodOptions?`: `AllMethodOptions`) => `Promise`<`components`[``"schemas"``][``"pool_list_extended"``]\> = `poolsExtendedAll`
...
• **poolsRetired**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `pagination?`: `PaginationOptions`) => `Promise`<`components`[``"schemas"``][``"pool_list_retire"``]\> = `poolsRetired`
...
• **poolsRetiring**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `pagination?`: `PaginationOptions`) => `Promise`<`components`[``"schemas"``][``"pool_list_retire"``]\> = `poolsRetiring`
...
• **root**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI)) => `Promise`<{ `url`: `string` ; `version`: `string`  }\> = `root`
...
• **scripts**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `pagination?`: `PaginationOptions`) => `Promise`<`components`[``"schemas"``][``"scripts"``]\> = `scripts`
...
• **scriptsByHash**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `scriptHash`: `string`) => `Promise`<`components`[``"schemas"``][``"script"``]\> = `scriptsByHash`
...
• **scriptsCbor**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `scriptHash`: `string`) => `Promise`<`components`[``"schemas"``][``"script_cbor"``]\> = `scriptsCbor`
...
• **scriptsDatum**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `datumHash`: `string`) => `Promise`<`components`[``"schemas"``][``"script_datum"``]\> = `scriptsDatum`
...
• **scriptsDatumCbor**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `datumHash`: `string`) => `Promise`<`components`[``"schemas"``][``"script_datum_cbor"``]\> = `scriptsDatumCbor`
...
• **scriptsJson**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `scriptHash`: `string`) => `Promise`<`components`[``"schemas"``][``"script_json"``]\> = `scriptsJson`
...
• **scriptsRedeemers**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `scriptHash`: `string`) => `Promise`<`components`[``"schemas"``][``"script_redeemers"``]\> = `scriptsRedeemers`
...
• **txSubmit**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `transaction`: `string` \| `Uint8Array`) => `Promise`<`string`\> = `txSubmit`
...
• **txs**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `hash`: `string`) => `Promise`<`components`[``"schemas"``][``"tx_content"``]\> = `txs`
...
• **txsDelegations**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `hash`: `string`) => `Promise`<`components`[``"schemas"``][``"tx_content_delegations"``]\> = `txsDelegations`
...
• **txsMetadata**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `hash`: `string`) => `Promise`<`components`[``"schemas"``][``"tx_content_metadata"``]\> = `txsMetadata`
...
• **txsMetadataCbor**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `hash`: `string`) => `Promise`<`components`[``"schemas"``][``"tx_content_metadata_cbor"``]\> = `txsMetadataCbor`
...
• **txsMirs**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `hash`: `string`) => `Promise`<`components`[``"schemas"``][``"tx_content_mirs"``]\> = `txsMirs`
...
• **txsPoolRetires**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `hash`: `string`) => `Promise`<`components`[``"schemas"``][``"tx_content_pool_retires"``]\> = `txsPoolRetires`
...
• **txsPoolUpdates**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `hash`: `string`) => `Promise`<`components`[``"schemas"``][``"tx_content_pool_certs"``]\> = `txsPoolUpdates`
...
• **txsRedeemers**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `hash`: `string`) => `Promise`<`components`[``"schemas"``][``"tx_content_redeemers"``]\> = `txsRedeemers`
...
• **txsStakes**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `hash`: `string`) => `Promise`<`components`[``"schemas"``][``"tx_content_stake_addr"``]\> = `txsStakes`
...
• **txsUtxos**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `hash`: `string`) => `Promise`<`components`[``"schemas"``][``"tx_content_utxo"``]\> = `txsUtxos`
...
• **txsWithdrawals**: (`this`: [`BlockFrostAPI`](../wiki/BlockFrostAPI), `hash`: `string`) => `Promise`<`components`[``"schemas"``][``"tx_content_withdrawals"``]\> = `txsWithdrawals`
